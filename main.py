...
def login_dynamic():
    class user_login:
        ...
        def __init__(self):
            ...
            self.label_msg1 = canvas.create_text((150, 150), text="Employee Id", justify=tk.CENTER,
    ...
    class wfh:
        ...
        def start(self):
            ...
            if not self._running:
                ...
                sliced_image = resize_screenshot[round(re_hei/6.75):re_hei-round(re_hei/6.75), 0:re_wid]  # slicing image for blurring
                ...
                #------------------code for warning message pop up screen-----------------------------------

                # self._elapsedtime = time.time() - self._start
                # task_time = 400
                # print("elapsed time inside start===", self._elapsedtime)
                # if (self._elapsedtime == (task_time - (3 * 60))):
                #     messagebox.showwarning("warning", "remaining time")
        ...
        def insert(self, time, date):
            ...
            if self.connect():
                ...
                data = {"useruniqueid": str(user_unique_id),
                        ...
                        "captureddate": str(date), "requesttype": str("face")}
